...
. Login to your Jenkins instance at https://jenkins-0.pcfsony.com.

. Make sure the following plug-ins are installed:
+
* Gradle
* Mask Passwords
...
. Click +New Job+, give it the name +cf-spring-mvc+ and select ``Build a free-style software project.'' Then click +OK+.

. Under +Source Code Management+, select +Git+, and supply your repository URL (e.g. `https://github.com/<YOUR_GIT_USERNAME>/cf-spring-mvc`).
