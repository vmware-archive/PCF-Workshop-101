...
. Scale the app via the command line
+
----
$ cf scale <<app_name>> -i 2
----

. Scale the app from the application manager

.. Login to https://run.pivotal.io
.. Navigate to your space and application
.. Use the GUI to scale your app
