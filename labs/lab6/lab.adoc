...
====
----
Using manifest file /Users/azwickey/development/customers/sony/PCF-Bootcamp/dev-workshop/cf-workshop-spring-mvc/manifest.yml <1>
...
Uploading app files from: /Users/azwickey/development/customers/sony/PCF-Bootcamp/dev-workshop/cf-workshop-spring-mvc/target/cf-workshop-spring-mvc-0.1.war
