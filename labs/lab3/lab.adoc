...
. Note this lab is deprecated for the Diego runtime, please use 'cf ssh APP_NAME' instead: https://docs.pivotal.io/pivotalcf/customizing/diego-ssh/access-apps.html
+
