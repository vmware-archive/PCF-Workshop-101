...
public class TradeController {
	...
	public ResponseEntity<Quote> quote(@PathVariable("symbol") final String symbol)  {
		logger.debug("/trade.QUOTE");
		...
		return new ResponseEntity<Quote>(quote, responseHeaders, HttpStatus.OK);
	}
